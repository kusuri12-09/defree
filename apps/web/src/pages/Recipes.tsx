      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {recipes.map((recipe) => (
            <div
              key={recipe.id}
              className="bg-surface rounded-xl overflow-hidden shadow-sm border border-neutral-100 relative"
            >
              ...
              <div className="h-32 bg-neutral-100 flex items-center justify-center">
                <img
                  src={recipe.thumbnailUrl || 'https://via.placeholder.com/400x200?text=Recipe'}
                  alt={recipe.title}
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-neutral-500 mt-1">
                  ⏱ {recipe.cookTimeMinutes || 15}분 · 부족 재료 {recipe.missingCount}개
                </p>
                <div className="mt-3 flex justify-between items-center text-primary text-sm font-medium">
                  <span>
                    {recipe.missingCount === 0 ? '✅ 바로 요리 가능' : '🛒 조금만 사면 가능'}
                  </span>
