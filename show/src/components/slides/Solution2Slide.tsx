      ...
      <div className="grid md:grid-cols-2 gap-8 w-full">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="bg-[#5865F2]/20 border border-[#5865F2] p-4 rounded-xl mb-6">
              ...
              <p className="text-sm">"승리 님, 냉장고에 <span className="text-danger font-bold">방울토마토</span>가 죽어가고 있어요!"</p>
            </div>
            <h3 className="text-2xl font-bold mb-2">친숙한 알림 연동</h3>
            <p className="text-slate-400">디스코드, 슬랙 등 자주 보는 플랫폼으로 알림 전송. 앱을 켜지 않아도 알려줍니다.</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-400">단순 경고에서 끝나지 않고, 현재 남은 재료만으로 당장 만들 수 있는 요리를 추천합니다.</p>
          </div>
        </motion.div>
      </div>
    </div>
