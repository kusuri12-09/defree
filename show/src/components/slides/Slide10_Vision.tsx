  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-5xl px-8 w-full text-center">
      ...
      >
        ...
        <p className="text-2xl font-light text-slate-300">낭비 없는 식탁, <span className="text-primary font-bold">지속 가능한 자취 생활</span>의 시작</p>
      </motion.div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 mt-12 w-full">
        ...
        >
          ...
          <p className="text-sm text-slate-400">연간 가구당 음식물 쓰레기<br/>배출량 30% 감소</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-slate-400">불필요한 중복 구매 방지로<br/>월 평균 식비 절감</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-slate-400">"오늘 뭐 먹지?" 고민 없는<br/>건강한 1인 가구 생태계 구축</p>
        </motion.div>
      </div>
    </div>
  );
